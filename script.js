    ...
    form.addEventListener('submit', function (e) {
        ...
        if (heightInput === '' || height <= 0 || isNaN(height)) {
            ...
            if (bmi < 18.6) {
                ...
                message += `<span class="message"><b>Underweight</b>. You need to gain approximately <b>${weightToGain} kg</b> to reach a normal weight.</span>`;
            } else if (bmi >= 18.6 && bmi <= 24.9) {
                message += `<span class="message"><b>Normal range</b>. Maintain your current weight.</span>`;
            } else {
